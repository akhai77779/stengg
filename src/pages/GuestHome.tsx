    ...
    <GuestLayout>
      ...
      <section className="py-24 bg-[#0a0e1a] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <button 
            className="px-8 py-4 min-h-[48px] min-w-[120px] border border-white text-white hover:bg-white hover:text-[#0a0e1a] active:bg-white/90 active:scale-95 text-base tracking-wide transition-all duration-200 touch-manipulation select-none"
            style={{ WebkitTapHighlightColor: 'transparent' }}
          >
            {t('guest.discover')}
          </button>
