...
const translations: Record<Language, Record<string, string>> = {
  vi: {
    ...
    'profile.switchAccount': 'Chuyển đổi tài khoản',
    ...
    'security.twoFactorAuth': 'Xác thực danh tính kép',
    'security.twoFactorDesc': 'Để bảo vệ tài khoản của bạn, nên cho phép ít nhất một xác thực danh tính kép',
    'security.verifyPhone': 'Xác minh điện thoại di động',
    'security.verifyEmail': 'Xác minh email',
    'security.loginPassword': 'Đăng nhập mật khẩu',
    'security.withdrawalPassword': 'Mật khẩu rút tiền',
    'security.change': 'Thay đổi',
    'security.create': 'Tạo mật khẩu rút tiền',
    'security.changeLoginPassword': 'Thay đổi mật khẩu đăng nhập',
    'security.changeWithdrawalPassword': 'Thay đổi mật khẩu rút tiền',
    'security.createWithdrawalPassword': 'Tạo mật khẩu rút tiền',
    'security.currentPassword': 'Mật khẩu hiện tại',
    'security.newPassword': 'Mật khẩu mới',
    'security.confirmPassword': 'Xác nhận mật khẩu',
    'security.enterCurrentPassword': 'Nhập mật khẩu hiện tại',
    'security.enterNewPassword': 'Nhập mật khẩu mới',
    'security.enterConfirmPassword': 'Nhập lại mật khẩu mới',
    'security.passwordMismatch': 'Mật khẩu xác nhận không khớp',
    'security.passwordTooShort': 'Mật khẩu phải có ít nhất 6 ký tự',
    'security.passwordChanged': 'Đã thay đổi mật khẩu thành công',
    'security.withdrawalPasswordChanged': 'Đã thay đổi mật khẩu rút tiền thành công',
    'security.withdrawalPasswordCreated': 'Đã tạo mật khẩu rút tiền thành công',

    // Identity Verification
    'identity.title': 'Xác minh danh tính',
    'identity.description': 'Xác minh danh tính để bảo vệ tài khoản và sử dụng đầy đủ tính năng',
    'identity.verifyIdentity': 'Xác minh danh tính',
    'identity.documentType': 'Loại giấy tờ',
    'identity.cccd': 'CCCD/CMND',
    'identity.passport': 'Hộ chiếu',
    'identity.cccdNumber': 'Số CCCD/CMND',
    'identity.passportNumber': 'Số hộ chiếu',
    'identity.fullName': 'Họ và tên',
    'identity.nameNote': 'Tên hiển thị từ thông tin đăng ký, không thể thay đổi',
    'identity.dateOfBirth': 'Ngày tháng năm sinh',
    'identity.address': 'Địa chỉ cư trú',
    'identity.addressPlaceholder': 'Nhập địa chỉ thường trú của bạn',
    'identity.expiryDate': 'Ngày hết hạn',
    'identity.frontPhoto': 'Ảnh mặt trước',
    'identity.backPhoto': 'Ảnh mặt sau',
    'identity.uploadFrontPhoto': 'Tải lên ảnh mặt trước',
    'identity.uploadBackPhoto': 'Tải lên ảnh mặt sau',
    'identity.photoWarning': 'Yêu cầu chụp rõ nét, đầy đủ 4 góc, không bị mờ hoặc che khuất',
    'identity.invalidImageType': 'Vui lòng chọn file hình ảnh',
    'identity.imageTooLarge': 'Kích thước file không được vượt quá 5MB',
    'identity.imageUploaded': 'Đã tải lên hình ảnh',
    'identity.uploadFailed': 'Không thể tải lên hình ảnh',
    'identity.fillAllFields': 'Vui lòng điền đầy đủ thông tin',
    'identity.submitSuccess': 'Yêu cầu xác minh đã được gửi thành công',
    ...
    'options.buyUp': 'Lệnh Mua',
    'options.buyDown': 'Lệnh Bán',
    'options.buyNow': 'Lệnh Mua',
    'options.sellNow': 'Lệnh Bán',
    ...
    // Quick Login
    'quickLogin.setupTitle': 'Thiết lập đăng nhập nhanh',
    'quickLogin.setupDesc': 'Chọn phương thức đăng nhập nhanh cho lần sau',
    'quickLogin.pinMethod': 'Mã PIN 6 số',
    'quickLogin.pinMethodDesc': 'Đăng nhập nhanh bằng mã PIN của bạn',
    'quickLogin.biometricMethod': 'Vân tay / Face ID',
    'quickLogin.biometricMethodDesc': 'Đăng nhập nhanh bằng sinh trắc học',
    'quickLogin.skip': 'Bỏ qua',
    'quickLogin.enterPin': 'Nhập mã PIN',
    'quickLogin.enterPinDesc': 'Tạo mã PIN 6 số để đăng nhập nhanh',
    'quickLogin.confirmPin': 'Xác nhận mã PIN',
    'quickLogin.confirmPinDesc': 'Nhập lại mã PIN để xác nhận',
    'quickLogin.pinMismatch': 'Mã PIN không khớp',
    'quickLogin.pinMismatchDesc': 'Vui lòng nhập lại mã PIN xác nhận',
    'quickLogin.setupSuccess': 'Thiết lập thành công',
    'quickLogin.pinSetupSuccess': 'Đã thiết lập đăng nhập bằng PIN',
    'quickLogin.biometricSetupSuccess': 'Đã thiết lập đăng nhập sinh trắc học',
    'quickLogin.setupFailed': 'Không thể thiết lập đăng nhập nhanh',
    'quickLogin.biometricSetupFailed': 'Không thể thiết lập sinh trắc học',
    'quickLogin.setupComplete': 'Hoàn tất thiết lập',
    'quickLogin.welcomeBack': 'Chào mừng trở lại',
    'quickLogin.enterYourPin': 'Nhập mã PIN của bạn',
    'quickLogin.unlock': 'Mở khóa',
    'quickLogin.tapToUnlock': 'Chạm để xác thực sinh trắc học',
    'quickLogin.usePassword': 'Sử dụng mật khẩu',
    'quickLogin.wrongPin': 'Mã PIN không đúng',
    'quickLogin.attemptsRemaining': 'Còn {{count}} lần thử',
    'quickLogin.maxAttempts': 'Quá nhiều lần thử sai',
  ...
  en: {
    ...
    'admin.transactions': 'Withdrawal Orders',
    'admin.auditLogs': 'Audit Logs',
    'admin.users': 'Users',
    ...
    'charity.allFunds': 'All funds',
    'charity.fundCurrency': 'Fund currency',
    'charity.fundCycle': 'Fund cycle',
    'charity.comprehensiveRate': 'Comprehensive rate',
    'charity.days': 'days',
    'charity.noPrograms': 'No charity programs yet',
    ...
    'security.twoFactorDesc': 'To protect your account, you should enable at least one two-factor authentication method',
    'security.verifyPhone': 'Verify Mobile Phone',
    ...
    'security.create': 'Create Withdrawal Password',
    'security.changeLoginPassword': 'Change Login Password',
    'security.changeWithdrawalPassword': 'Change Withdrawal Password',
    'security.createWithdrawalPassword': 'Create Withdrawal Password',
    ...
    'security.enterConfirmPassword': 'Confirm new password',
    ...
    'security.withdrawalPasswordChanged': 'Withdrawal password changed successfully',
    'security.withdrawalPasswordCreated': 'Withdrawal password created successfully',

    // Identity Verification
    'identity.title': 'Identity Verification',
    'identity.description': 'Verify your identity to protect your account and access full features',
    'identity.verifyIdentity': 'Verify Identity',
    'identity.documentType': 'Document Type',
    'identity.cccd': 'National ID Card',
    'identity.passport': 'Passport',
    'identity.cccdNumber': 'ID Card Number',
    'identity.passportNumber': 'Passport Number',
    'identity.fullName': 'Full Name',
    'identity.nameNote': 'Name from registration info, cannot be changed',
    'identity.dateOfBirth': 'Date of Birth',
    'identity.address': 'Residential Address',
    'identity.addressPlaceholder': 'Enter your permanent address',
    'identity.expiryDate': 'Expiry Date',
    'identity.frontPhoto': 'Front Photo',
    'identity.backPhoto': 'Back Photo',
    'identity.uploadFrontPhoto': 'Upload front photo',
    'identity.uploadBackPhoto': 'Upload back photo',
    'identity.photoWarning': 'Photos must be clear, show all 4 corners, not blurry or obscured',
    'identity.invalidImageType': 'Please select an image file',
    'identity.imageTooLarge': 'File size must not exceed 5MB',
    'identity.imageUploaded': 'Image uploaded successfully',
    'identity.uploadFailed': 'Failed to upload image',
    'identity.fillAllFields': 'Please fill in all fields',
    'identity.submitSuccess': 'Verification request submitted successfully',
    ...
    'options.buyUp': 'Buy Order',
    'options.buyDown': 'Sell Order',
    'options.buyNow': 'Buy Order',
    'options.sellNow': 'Sell Order',
    ...
    // Quick Login
    'quickLogin.setupTitle': 'Set up Quick Login',
    'quickLogin.setupDesc': 'Choose a quick login method for next time',
    'quickLogin.pinMethod': '6-digit PIN',
    'quickLogin.pinMethodDesc': 'Quick login with your PIN code',
    'quickLogin.biometricMethod': 'Fingerprint / Face ID',
    'quickLogin.biometricMethodDesc': 'Quick login with biometrics',
    'quickLogin.skip': 'Skip',
    'quickLogin.enterPin': 'Enter PIN',
    'quickLogin.enterPinDesc': 'Create a 6-digit PIN for quick login',
    'quickLogin.confirmPin': 'Confirm PIN',
    'quickLogin.confirmPinDesc': 'Re-enter your PIN to confirm',
    'quickLogin.pinMismatch': 'PIN does not match',
    'quickLogin.pinMismatchDesc': 'Please re-enter the confirmation PIN',
    'quickLogin.setupSuccess': 'Setup successful',
    'quickLogin.pinSetupSuccess': 'PIN login has been set up',
    'quickLogin.biometricSetupSuccess': 'Biometric login has been set up',
    'quickLogin.setupFailed': 'Unable to set up quick login',
    'quickLogin.biometricSetupFailed': 'Unable to set up biometrics',
    'quickLogin.setupComplete': 'Complete setup',
    'quickLogin.welcomeBack': 'Welcome back',
    'quickLogin.enterYourPin': 'Enter your PIN',
    'quickLogin.unlock': 'Unlock',
    'quickLogin.tapToUnlock': 'Tap to authenticate with biometrics',
    'quickLogin.usePassword': 'Use password',
    'quickLogin.wrongPin': 'Wrong PIN',
    'quickLogin.attemptsRemaining': '{{count}} attempts remaining',
    'quickLogin.maxAttempts': 'Too many failed attempts',
